...
-<div className="swiper-slide"> -<div className="crumina-module
crumina-pricing-table pricing-table--small">
<div
className="pricing-thumb"> <img src="img/
if_Bitcoin_2745023.png" className="Woox-icon"
alt=" " />
...
<svg className="woox-icon icon-arrow-up
 arrow-up active">
...
<a className="btn btn-large btn--dark-lighter btn-transparent
full-width">
Buy Bitcoin Now! </a>
</div>

<div className="swiper-slide"> -<div className="crumina-module
curmina-pricing-table pricing-table--small">
<div
className="pricing-thumb"> <img src="img/
if_Bitcoin_2745023.png" className="Woox-icon"
alt=" " />
